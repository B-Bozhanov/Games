namespace Snake.Tests.SnakeTests
{
    ...
    public class SnakeTests
    {
        ...
        public void NextHeadDirection_Should_Calculated_Correctly() 
        {
            ...
            snake.Move(SnakeGame.GameObjects.Enums.Direction.Up);
            ...
            var nextHead = snake.GetNextHeadPossition(SnakeGame.GameObjects.Enums.Direction.Down);//(Direction.Down); // или както ти е метода
        ...
        public void ChangeDirection_Should_Ignore_Opposite()
        {
            ...
            Assert.Equal(SnakeGame.GameObjects.Enums.Direction.Right, snake.CurrentDirection);
        }
        ...
        {
            var snake = new Snake();
            var nextHead = snake.GetNextHeadPossition(SnakeGame.GameObjects.Enums.Direction.Right);
            var obstacle = nextHead; // на следващата клетка
            var board = new Coordinates(100, 100);

            Assert.True(snake.WillDie(board, obstacle, SnakeGame.GameObjects.Enums.Direction.Right));
        }
        ...
        public void WillDie_Should_ReturnTrue_When_OutOfBoard()
        {
            ...
            Assert.True(snake.WillDie(smallBoard, new Coordinates(500, 500), SnakeGame.GameObjects.Enums.Direction.Right));
        }
        ...
        public void WillDie_ShouldBeFalse_For_RightDownDownLeftUp()
        {
            ...
            Assert.False(snake.WillDie(board, obstacle, SnakeGame.GameObjects.Enums.Direction.Up));
        }
        ...
        public void WillDie_ShouldBeTrue_For_RightDownLeftUp()
        {
            ...
            Assert.True(snake.WillDie(board, obstacle, SnakeGame.GameObjects.Enums.Direction.Up));
        }
        ...
        public void Snake_ShouldSurvive_WhenStepsOnTailThatIsAboutToMove()
        {
            ...
            var willDie = snake.WillDie(board, obstacle, SnakeGame.GameObjects.Enums.Direction.Down /*, Direction.Down ако вече подаваш посока */);
